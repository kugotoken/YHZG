  ...
  return (
    <section className="relative w-full min-h-screen flex flex-col items-center justify-center px-4 pt-20 pb-10 overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-5xl mx-auto flex flex-col items-center gap-8">
        ...
        <motion.a
          href="https://app.binance.com/uni-qr/cvid/34406765502914?r=GKB8DETJ&l=zh-CN&uco=i2ISbkIgVhjK8-NY3oonjg&uc=app_square_share_link&us=copylink"
          target="_blank"
          rel="noopener noreferrer"
          className="flex items-center gap-1 text-gold-400/80 text-sm hover:text-gold-300 transition-colors underline underline-offset-4 decoration-gold-400/30 hover:decoration-gold-300 -mt-2"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
          transition={{ delay: 0.4, duration: 0.8 }}
        >
          <ExternalLink size={14} />
          {t.view_original_video}
        </motion.a>
        ...
        >
          ...
          <cite className="block text-gold-400 font-sans font-bold text-lg not-italic mt-4">{t.author}</cite>
        </motion.div>
        ...
        >
          ...
          <a 
            href="https://flap.sh/bnb/0xb0e80e59df429bb9c6a255b628c59097c6f57777" 
            target="_blank"
            rel="noopener noreferrer"
